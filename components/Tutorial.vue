...
<style>
  *{
  ...
  .contact_items .item input{
    ...
    padding: 5px;
    box-shadow: inset 0 0 2px 0 rgb(16 39 59 / 70%);
    margin: 5px auto;
    
  }
  .contact_items .item textarea{
    display: inline-block;
    width: 68%;
    height: 120px;
    min-height: 80px;
...
export default {
    ...
    head: {
      meta: [
        { hid: 'og:title', property: 'og:title', content: 'My Portfolio site' },
        { hid: 'og:image', property: 'og:image', content: 'MyPortfolio.png' },
        { hid: 'og:description', property: 'og:description', content: 'ワイのポートフォリオ' },
      ],
    },
    data() {
        return {
